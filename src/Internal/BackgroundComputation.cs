// Copied from VL.Stride.Text3d (src\Core\BackgroundComputation.cs), keep in sync.
// Only the namespace and visibility differ; a shared package would be overkill for
// these ~75 lines.
//
// Poll-based background computation helper for the async hull baking nodes.
//
...
internal sealed class BackgroundComputation<TResult> where TResult : class
{
