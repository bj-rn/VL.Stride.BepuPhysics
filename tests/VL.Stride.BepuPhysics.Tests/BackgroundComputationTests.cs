// Tests for the poll-based async helper behind the (Async) hull baking nodes.
// Ported from VL.Stride.Text3d's BackgroundComputationTests (the helper is a copy,
// kept in sync — see src\Internal\BackgroundComputation.cs).
